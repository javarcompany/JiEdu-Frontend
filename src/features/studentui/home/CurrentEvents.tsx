            ...
            <div className="ml-4 mt-4">
                <div className="flex gap-2 mb-4 flex-row justify-between">
                    ...
                    <div className="flex flex-row items-end">
                        <button onClick={() => navigate("/my-events")} className="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                            <svg
