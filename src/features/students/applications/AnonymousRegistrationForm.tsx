...
export default function AnonymousRegistrationForm() {
    ...
    return (
        <>
            ...
            <div className="fixed z-999 top-3 right-3 sm:block">
                <ThemeTogglerTwo />
            </div>
            <div className="sticky top-0 z-99 items-center w-full h-full shadow-lg  py-2 bg-brand-950 dark:bg-gray-900 lg:grid">
                <div className="flex flex-col items-center text-white ">
                    <Link to="/" className="items-center">
                        <img
                            ...
                            alt="Logo"
                        />
                        All-In-One School Management Information System.
                    </Link>
                </div>
            </div>

		    <div className="relative p-6 lg:py-4 lg:px-10 lg:shadow-2xl bg-white z-0 dark:bg-gray-900 sm:p-0">
