  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <Button
          onClick={logout}
          className="flex items-center gap-3 px-3 py-2 mt-3 font-medium bg-red-600 text-white rounded-lg group text-theme-sm hover:bg-red-100 hover:text-gray-700 dark:text-white dark:hover:bg-white/5 dark:hover:text-gray-300"
        >
          <svg
